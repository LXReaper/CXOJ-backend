...
public interface AnnouncementsService extends IService<Announcements> {
     ...
     * @return
     */
    Long addAnnouncements(AnnouncementsAddRequest announcementsAddRequest);
     ...
     * @return
     */
    Boolean editAnnouncements(AnnouncementsEditRequest announcementsEditRequest, HttpServletRequest request);
